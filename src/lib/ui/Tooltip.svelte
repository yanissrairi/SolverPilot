...
<div class="group relative inline-block {className}">
  ...
  <div
    class="pointer-events-none absolute z-50 opacity-0 transition-opacity duration-200 group-hover:opacity-100 {positionClasses[position]}"
  >
    <div
    ...
    <!-- Arrow -->
    <div
      class="absolute h-0 w-0 border-4 border-transparent {arrowClasses[position]}"
    ></div>
  </div>
</div>
